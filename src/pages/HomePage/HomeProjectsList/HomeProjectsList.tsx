...
export const AppProjectsList: React.FC = () => {
  ...
  const projects: Project[] = useAppSelector(selectProjectsItems);
  const filterProject: string = useAppSelector(selectProjectsFiltered);
  const loading: boolean = useAppSelector(selectProjectsLoading);
  const error: string | null = useAppSelector(selectProjectError);
