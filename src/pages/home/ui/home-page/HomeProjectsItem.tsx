...
// import { AppAuth } from '../auth/logic/useAuth.ts';
...
//           <Typography
//             variant='body2'
//             sx={{ color: 'text.secondary', fontSize: { xs: '0.6rem', sm: '1.1rem' } }}
//           >
...
//         >
//           <Button
//             sx={{ fontSize: { xs: '0.5rem', lg: '0.75rem', sm: '0.8rem' }, minWidth: 'unset' }}
//             size='small'
