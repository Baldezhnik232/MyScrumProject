...
export const AppSprintsList = () => {
  ...
  useEffect((): void => {
    ...
    const projectSprints: Sprint[] = sprints.filter((sprint) => String(sprint.projectId) === id);
  ...
  console.log("Все спринты: ", sprints);
  console.log("Фильтрованные спринты: ", projectSprints);
